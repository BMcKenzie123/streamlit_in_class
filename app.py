...
class LinearRegression:
    ...
    def fit(self, X, y):
        ...
        for iteration in range(self.n_iterations):
            ...
            self.weights -= self.learning_rate * dw  # WRITE YOUR CODE HERE
...
def compute_metrics(y_true, y_pred):
    ...
    r2 = 1 - (ss_res / ss_tot) if ss_tot != 0 else 0      # REPLACE THIS
...
def plot_predictions(X, y_true, y_pred, y_actual=None):
    ...
    if y_actual is not None:
        ...
        # WRITE YOUR CODE HERE
        fig.add_trace(go.Scatter(x=X.flatten(), y=y_actual, mode='markers', name='Actual Data', marker=dict(color='LightSkyBlue')))
        pass

    # Add line for true function (if available)
    fig.add_trace(go.Scatter(x=X.flatten(), y=y_true, mode='lines', name='True Function', line=dict(color='Teal')))
    # Sort by X for proper line plotting
    sort_idx = np.argsort(X.flatten())
    # WRITE YOUR CODE HERE
    fig.add_trace(go.Scatter(x=X.flatten()[sort_idx], y=y_pred[sort_idx], mode='lines', name='Predictions', line=dict(color='Orange')))
...
def plot_residuals(y_true, y_pred):
    ...
    # Hint: Use go.Scatter with mode='markers'
    # WRITE YOUR CODE HERE
    fig.add_trace(go.Scatter(x=y_pred, y=residuals, mode='markers', name='Residuals', marker=dict(color='MediumPurple')))
    # Add horizontal line at y=0
    # Hint: Use fig.add_hline()
    # WRITE YOUR CODE HERE
    fig.add_hline(y=0, line_dash='dash', line_color='Red', annotation_text='Zero Error', annotation_position='top left')
    fig.update_layout(
